...
import { AppStatus, UploadedFile, User, PlanType, View, ProcessOptions } from './types';
import { healWatermark, convertPdfToImages } from './utils/imageProcessor';
          ...
          <div className="space-y-12">
            {status === AppStatus.IDLE && (
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-12">
                ...
                <div className="max-w-3xl mx-auto">
                  ...
                  <p className="text-center mt-6 text-gold/60 text-xs font-bold uppercase tracking-widest">
                    Outil 100% Gratuit & Illimité
                  </p>
                </div>
              </div>
            )}
            ...
            {status === AppStatus.PROCESSING && (
              <div className="bg-anthracite-light rounded-[2.5rem] border border-anthracite-lighter p-16 text-center space-y-8 animate-in fade-in zoom-in duration-500">
                <div className="w-24 h-24 border-4 border-gold/20 border-t-gold rounded-full animate-spin mx-auto"></div>
                <div className="max-w-md mx-auto space-y-4">
                  <h3 className="text-2xl font-black text-white uppercase tracking-widest">SmartUnityIA en action</h3>
